   ...
   while(1)
   {
    ...
    /* USER CODE BEGIN 3 */
      ...
      if(imaincount++>=10)
      {
         ...
         //read flash 
         idata32 = 0x02020202; iputbytes1( (uint8_t*)(&idata32), 4);  //--test           
         idata32 = *(__IO uint32_t *)(0x8007000);  
         iputbytes1( (uint8_t*)(&idata32), 4);  
...
////         EraseInitStruct.Page        = 14;                        //FLASH_FLAG_PAGE     //7000
...
////         } 
         ...
         //write flash
         if (HAL_FLASH_Program(FLASH_TYPEPROGRAM_DOUBLEWORD, 0x8007000, 0xffffffff00000000+GOBOOTLOAD ) != HAL_OK)
         {
            ;//iputbytes1( (uint8_t*)"save flash err\r\n", 16);  
         }   
         
         //read flash 
         idata32 = 0x03030303; iputbytes1( (uint8_t*)(&idata32), 4);  //--test    
         idata32 = *(__IO uint32_t *)(0x8007000);  
         
         //if(idata32!=GOBOOTLOAD)
           iputbytes1( (uint8_t*)(&idata32), 4);  
