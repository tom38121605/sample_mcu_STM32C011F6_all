...
//volatile uint32_t  isensorcount=0;
...
volatile uint8_t ommo_timer_spi_flag = 0;
volatile uint8_t ommo_timer_uart_report_flag = 0;

volatile uint8_t timer_1m_cnt[2];
