...
#define SOMA_MODE  2
    //0 -- write virtual eeprom data   
    //1 -- write bootload bin file data
    //2 -- read sensor data


#define TESTDATA_MODE   6
    //0 -- all 0
    //1 -- all 1
    //2 -- bit-wise checkerboard
    //3 -- inverse bit-wise checkerboard
    //4 -- byte-wise checkerboard  
    //5 -- inverse byte-wise checkerboard  
    //6 -- no change 
